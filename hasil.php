...
//Bobot
$W1	= $_POST['harga_motor'];
$W2	= $_POST['kapasitas_mesin'];
$W3	= $_POST['kapasitas_tengki'];
$W4	= $_POST['warna'];
$W5	= $_POST['model'];
			...
			<div class="container">
				...
				<div class="nav-wrapper">
					<ul class="left" style="margin-left: -52px;">
						...
						<li><a href="daftar_motor.php">DAFTAR SEPEDA MOTOR MATIC</a></li>
	...
	<div style="background-color: #efefef">
		<div class="container">
			<div class="section-card" style="padding: 20px 0px">
				...
				<center>
					<h4 class="header" style="margin-left: 24px; margin-bottom: 0px; margin-top: 24px; color: #635c73;">HASIL REKOMENDASI SEPEDA MOTOR MATIC</h4>
				</center>
				<ul>
					<li>
						<div class="row">
							<div class="card">
								<div class="card-content">
									<h5 style="margin-bottom: 16px; margin-top: -6px;">Matrik Sepeda Motor Matic</h5>
									<table class="responsive-table">
										...
										<tbody>
											...
											while ($data_motor=mysqli_fetch_array($query)) {
												$Matrik[$no-1]=array($data_motor['harga_motor'],$data_motor['kapasitas_mesin'],$data_motor['kapasitas_tengki'],$data_motor['warna'],$data_motor['model'] );
												?>
												<tr>
													<td><center><?php echo "A",$no ?></center></td>
													<td><center><?php echo $data_motor['harga_motor'] ?></center></td>
													<td><center><?php echo $data_motor['kapasitas_mesin'] ?></center></td>
													<td><center><?php echo $data_motor['kapasitas_tengki'] ?></center></td>
													<td><center><?php echo $data_motor['warna'] ?></center></td>
													<td><center><?php echo $data_motor['model'] ?></center></td>
												</tr>
												<?php
												$no++;
											}
									...
									<table class="responsive-table">
										...
										<tbody>
											...
											while ($data_motor=mysqli_fetch_array($query)) {
												...
												$MatrikNormalisasi[$no-1]=array($data_motor['harga_motor']/$pembagiNM[0],
													$data_motor['kapasitas_mesin']/$pembagiNM[1],
													$data_motor['kapasitas_tengki']/$pembagiNM[2],
													$data_motor['warna']/$pembagiNM[3],
													$data_motor['model']/$pembagiNM[4]);

													?>
													<tr>
														<td><center><?php echo "A",$no ?></center></td>
														<td><center><?php echo round($data_motor['harga_motor']/$pembagiNM[0],6)?></center></td>
														<td><center><?php echo round($data_motor['kapasitas_mesin']/$pembagiNM[1],6) ?></center></td>
														<td><center><?php echo round($data_motor['kapasitas_tengki']/$pembagiNM[2],6) ?></center></td>
														<td><center><?php echo round($data_motor['warna']/$pembagiNM[3],6) ?></center></td>
														<td><center><?php echo round($data_motor['model']/$pembagiNM[4],6) ?></center></td>
													</tr>
													<?php
													$no++;
												}
								...
								<div class="card">
									...
									<h5 style="margin-bottom: 16px; margin-top: -6px;">BOBOT (W)</h5>
										<table class="responsive-table">
											<thead>
												<tr>
													<th><center>Value Kriteria Harga Motor</center></th>
													<th><center>Value Kriteria Kapasitas Mesin</center></th>
													<th><center>Value Kriteria Kapasitas Tengki</center></th>
													<th><center>Value Kriteria Warna</center></th>
											...
											<table class="responsive-table" >
												...
												<thead style="border-top: 1px solid #d0d0d0;">
													<tr>
														...
														<th></th>
														<th><center>Alternatif Sepeda Motor Matic terpilih</center></th>
													</tr>
												</thead>
												<tbody>
													<tr>
		...
		<div id="about" class="modal">
			<div class="modal-content">
				<h4>Tentang</h4>
				<p>Sistem Pendukung Keputusan Pemilihan Sepeda Motor Matic ini menggunakan metode TOPSIS yang dibangun menggunakan bahasa PHP.
					Sistem ini dibuat sebagai Tugas Akhir Mata Kuliah Sistem Pendukung Keputusan Prodi Teknik Informatika Politeknik Harapan Bersama Kota Tegal. <br>
					<br>
					1. Fika Nur Hasari<br>
					2. Tri Hesti Wahyuningsih <a href="https://wahidari.gitlab.io/"> (Gitlab)</a><br>
				</p>
			</div>
		...
		<div class="footer-copyright" style="padding: 0px 0px; background-color: white">
			<div class="container">
				<p align="center" style="color: #999">&copy; Sistem Pendukung Keputusan Pemilihan Sepeda Motor Matic 2022.</p>
			</div>
		</div>
		<!-- Footer End -->
